...
contract DecompiledContract {
    ...
    function Unresolved_48b84f26() public payable {
        ...
        require(!(((var_g + ret0.length) - var_g) < 0x20), "Need Approved 300 USDC");
        require(var_h == (var_h), "Need Approved 300 USDC");
        require(var_h, "Need Approved 300 USDC");
        if (0x0a) {
            if (0x0a == 0x01) {
                if (0x0a == 0x02) {
                    if (!0x12 > 0xff) {
    ...
    function Unresolved_59307cf3() public payable {
        ...
        uint256 var_g = var_g + (uint248(ret0.length + 0x1f));
        require(!(((var_g + ret0.length) - var_g) < 0x20), "Need Approved 300 USDT");
        require(var_h == (var_h), "Need Approved 300 USDT");
        require(var_h, "Need Approved 300 USDT");
        if (0x0a) {
            if (0x0a == 0x01) {
                if (0x0a == 0x02) {
                    if (!0x12 > 0xff) {
    ...
    function Unresolved_0568cb7d() public payable {
        ...
        uint256 var_g = var_g + (uint248(ret0.length + 0x1f));
        require(!(((var_g + ret0.length) - var_g) < 0x20), "Need Approved 300 DAI");
        require(var_h == (var_h), "Need Approved 300 DAI");
        require(var_h, "Need Approved 300 DAI");
        if (0x0a) {
            if (0x0a == 0x01) {
                if (0x0a == 0x02) {
                    if (!0x12 > 0xff) {
