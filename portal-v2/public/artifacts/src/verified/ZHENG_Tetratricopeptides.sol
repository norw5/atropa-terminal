...
// Fetched 2026-09-09 during treasury-terminal research (session 17, queue 5c-iii)
// NB imports "addresses.sol" (repo: docs/solidity/addresses.sol) for libAtropaMathContract + AFFECTIONContract
